...
CFG = {
    ...
    # 'verbose_step': 1,
    'device': 'cuda:0',
    'exp_name': 'tf_efficientnet_b4_ns_bs8x2_nni',
}
...
t1_nni = tuner_params['t1']
t2_nni = tuner_params['t2']
label_smoothing_nni = tuner_params['label_smoothing']
    ...
    if fold == 0:  # try one fold
        ...
        for epoch in range(CFG['epochs']):
            train_one_epoch(epoch, model, loss_tr, optimizer, train_loader, device, scaler,
                            ...
                            t1=t1_nni, t2=t2_nni, label_smoothing=label_smoothing_nni)
